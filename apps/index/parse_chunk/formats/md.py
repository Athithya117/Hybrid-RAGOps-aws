...
try:
    ...
    log.error("pyarrow required for parquet-only mode; install pyarrow")
    sys.exit(1)
try:
    import tiktoken
    enc = None
...
try:
    ...
    log.error("markdown-it-py required")
    sys.exit(1)
...
if __name__ == "__main__":
    log.info("Starting markdown -> parquet parser")
