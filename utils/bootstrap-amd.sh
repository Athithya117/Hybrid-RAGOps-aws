...
install_eksctl() {
  ...
  if ! command -v eksctl &>/dev/null || \
    ...
    curl -fsSL https://github.com/weaveworks/eksctl/releases/download/${EKSCTL_VERSION}/eksctl_Linux_amd64.tar.gz \
      -o /tmp/eksctl.tar.gz
...
mkdir -p models && cd models && [ -f lid.176.bin ] || curl -L -o lid.176.bin https://dl.fbaipublicfiles.com/fasttext/supervised-models/lid.176.bin
