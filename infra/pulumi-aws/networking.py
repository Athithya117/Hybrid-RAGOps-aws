"""
Pulumi networking stack for RAG platform (VPC + Security Groups + EC2 KeyPair).
...
- Generates an RSA 4096 keypair via tls.PrivateKey, creates an AWS EC2 KeyPair
  with the public key, and writes the private PEM next to this file
  (./infra/pulumi-aws/<project>-<stack>-ec2-key.pem) with mode 0600.
